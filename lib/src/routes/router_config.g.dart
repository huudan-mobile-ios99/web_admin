      ...
      routes: [
        ShellRouteData.$route(
          ...
          routes: [
            ...
            GoRouteData.$route(
              path: '/newfb',
              factory: $FeedbackVRouteExtension._fromState,
            ),
            GoRouteData.$route(
              path: '/staff',
            ...
            GoRouteData.$route(
              path: '/car',
              factory: $FeedbackCarRouteExtension._fromState,
            ),
            GoRouteData.$route(
              path: '/updates',
...
extension $FeedbackVRouteExtension on FeedbackVRoute {
  static FeedbackVRoute _fromState(GoRouterState state) =>
...
extension $FeedbackCarRouteExtension on FeedbackCarRoute {
  static FeedbackCarRoute _fromState(GoRouterState state) =>
