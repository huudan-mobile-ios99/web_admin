...
abstract class MangaUrl {
  ...
  static String categoryId(int mangaId, String categoryId) =>"$_manga/$mangaId/category/$categoryId";
  ...
  static String chapterMetaWithIndex(int mangaId, int chapterIndex) =>"$_manga/$mangaId/chapter/$chapterIndex/meta";
